...
import { timeline } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate, timeline as timeline2, stagger } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { stagger as stagger2 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate2, stagger as stagger3, inView } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { inView as inView2 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { scroll } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { timeline as timeline3, inView as inView3 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate3 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate4 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { Delegate as Delegate2 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate5 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { Delegate as Delegate3 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { PhotoSwipeLightbox } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//dfbmvod.myshopify.com/cdn/shop/t/2/assets/photoswipe.min.js?v=23923577218600574321743441968"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { inView as inView4 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { timeline as timeline6 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate8 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate9 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
import { animate as animate10, inView as inView5 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
...
// js/theme.js
import { Delegate as Delegate4 } from "//dfbmvod.myshopify.com/cdn/shop/t/2/assets/vendor.min.js?v=21549124608892486191743441969";
(() => {
...
document.addEventListener('DOMContentLoaded', function() {
  if (window.location.href.indexOf('/products/') > -1) {
    var toggleElements = document.querySelectorAll('.accordion__toggle>span');
    toggleElements.forEach(function(element) {
      if (element.textContent.indexOf('Youth Size Chart') > -1) {
        var buttons = document.querySelectorAll('.variant-picker__option-info button.text-sm.text-subdued');
...
/*view port footer*/
function removeFullHeightClassIfExceedsViewport() {
  var container = $('.section.full_height');
  var viewportHeight = $(window).height();

  if (container.length && container.outerHeight() > viewportHeight) {
    container.removeClass('full_height');
  }
}
$(document).ready(function() {
  removeFullHeightClassIfExceedsViewport();
});
...
$('button.mute_button').click(function(ev){
    ev.preventDefault()
    ev.stopPropagation()
    ev.stopImmediatePropagation()
  $(this).toggleClass('umute');
  if(  $(this).parents('.content-over-media').find("video:first").prop('muted') ) {
          $(this).parents('.content-over-media').find("video:first").prop('muted', false);
    } else {
      $(this).parents('.content-over-media').find("video:first").prop('muted', true);
    }
});
$('button.video-pause-button').click(function(ev){
    ev.preventDefault()
    ev.stopPropagation()
    ev.stopImmediatePropagation()
    $(this).toggleClass('play');
    if ($(this).hasClass('play')) {
         $(this).parents('.content-over-media').find("video").get(0).pause();
      } else {
       $(this).parents('.content-over-media').find("video").get(0).play();
    }
});
$('.video-pause-button_mvod').click(function(ev){
  console.log('2');
  $(this).toggleClass('play');
  $('.bmpui-container-wrapper button.bmpui-ui-playbacktogglebutton').click();
});
$('.mute_button_mvod').click(function(ev){
  console.log('21');
  $(this).toggleClass('umute');
  $('.bmpui-container-wrapper button.bmpui-ui-volumetogglebutton').click();
});
$('button.full_screen_mvod').click(function(ev){
  $('.bmpui-container-wrapper button.bmpui-ui-fullscreentogglebutton').click();
});

$(document).ready(function() {
  if ($(window).width() < 960) {
  $('video-media.desk_video').remove();
  }
  /*if ($(window).width() < 768) {
    $('section.shopify-section.shopify-section--mvod_video .section').addClass('fixed-top');
    $('#details').click(function() {
      $(this).toggleClass('down');
      $(this).closest('.section.fixed-top>media-with-text').toggleClass('expand');
      $('section.shopify-section.shopify-section--mvod_video .section.fixed-top .media-with-text__content').toggleClass('show');
    });
  }*/
  $("video-media").closest(".media-with-text__media").removeClass("rounded");

  var $slider = $('collection-list.collection-list_carousel');
  var mob_item = $('collection-list.collection-list_carousel').attr('data-mobile_item');
  var slickData = $slider.data('slick');
  var slickOptions = slickData ? JSON.parse(slickData.replace(/'/g, '"')) : {};
  var $progressBar = $('.progress');
  var $progressBarLabel = $( 'span.progressbar' );
  ...
  $('product-list.VOD_product-list').slick({
    infinite: true,
    dots: true,
    prevArrow: '<button is="prev-button" class="circle-button circle-button--lg circle-button--fill border group animated-arrow--reverse"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="8" viewBox="0 0 16 8" fill="none"><path d="M11.5848 2.93286H0.0683594V4.85067H11.5848V7.72739L15.4108 3.89177L11.5848 0.0561523V2.93286Z" fill="white"></path></svg></button>',
...
//   console.log('1');
//     $slider.slick(useCSS: false);
// });
  
  
  $slider.slick({
    dots: slickOptions.dots || false,
    ...
    speed: slickOptions.speed,
    cssEase: slickOptions.cssEase,
    //pauseOnHover: slickOptions.pauseOnHover,
    prevArrow: '.owl-prev',
    nextArrow: '.owl-next',
    arrows: slickOptions.arrows,
    infinite: slickOptions.infinite,
    responsive: [
    {
      // tablet
      breakpoint: 991,
    ...
    },
    {
      ...
      breakpoint: 479,
      settings: {
        slidesToShow: mob_item
      }
    }
  ]
  });
  function handleClassChange(mutationsList, observer) {
  // Check if the class 'is-selected' has been added to or removed from any '.slideshow__slide' element
  $('.slideshow__slide').each(function() {
    if ($(this).hasClass('is-selected')) {
      var head_txt_color = $(this).find('> div[data-head_txt_color]').attr('data-head_txt_color');
      $('body').css('--header-text-color', head_txt_color);
    }
  });
}
...
// Define the target node and the type of mutations to observe
var targetNode = document.body; // You can change this to a more specific parent element if needed
var config = { attributes: true, subtree: true, attributeFilter: ['class'] };

// Start observing changes on the target node
observer.observe(targetNode, config);
});
const nextButton = document.querySelector('.circle-button.circle-button--lg.circle-button--fill.border.group.owl-next.owl_btn');
if (nextButton) {
    nextButton.addEventListener('click', function() {
        $('.slick-slider').slick('slickNext');
    });
} else {
    console.error('Element not found: .circle-button.circle-button--lg.circle-button--fill.border.group.owl-next.owl_btn');
}
const prevButton = document.querySelector('.circle-button.circle-button--lg.circle-button--fill.border.group.owl-prev.owl_btn');
if (prevButton) {
    prevButton.addEventListener('click', function() {
        $('.slick-slider').slick('slickPrev');
    });
} else {
    console.error('Element not found: .circle-button.circle-button--lg.circle-button--fill.border.group.owl-prev.owl_btn');
}
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOMContentLoaded event fired');
    const paragraphs = document.querySelectorAll('section.shopify-section.shopify-section--mvod_video .prose p');
    ...
    if (lastParagraph && readMoreBtn) {
        readMoreBtn.addEventListener('click', function() {
            console.log('Button clicked');
            isExpanded = !isExpanded;
            if (isExpanded) {
              lastParagraph.style.webkitLineClamp = 'initial';
              lastParagraph.classList.add('expanded')
              readMoreBtn.textContent = 'Read Less';
            } else {
              lastParagraph.style.webkitLineClamp = '2';
              lastParagraph.classList.remove('expanded');
              readMoreBtn.textContent = 'Read More';
            }
        });
    } else {
        console.log('Paragraph or button not found.');
    }
  //product card custom 
    const linkElement = document.querySelector('.product-card__figure>a');
    const hiddenInputElement = document.querySelector('.prpductform_card .product-info__buy-buttons form input[name="id"][aria-label="id"]');
    function updateHiddenInput() {
        if (linkElement && hiddenInputElement) {
            // Extract the variant ID from the href
            const url = new URL(linkElement.href);
            const variantId = url.searchParams.get('variant');
            console.log(variantId);
            if (variantId) {
                // Update the hidden input value
                hiddenInputElement.value = variantId;
            }
        }
    }
    const observer = new MutationObserver(updateHiddenInput);
    observer.observe(linkElement, { attributes: true, attributeFilter: ['href'] });
    updateHiddenInput();
});
